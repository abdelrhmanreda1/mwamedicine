      ...
      <div className="relative w-[98%] md:w-[90%] mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-[16px] md:text-2xl text-gray-800 leading-9">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <FaIndustry className="text-[#0389d2] w-16 md:w-12 h-6 mt-1" />
                <p className="text-[17px] md:text-lg text-gray-700 leading-8">
                  Based in Turkey, we serve multiple international markets with
                  reliable, science-backed pharmaceutical solutions.
                </p>
              </div>
              <div className="flex items-start gap-4">
                <FaGlobe className="text-[#0389d2] w-22 md:w-17 h-7 mt-1" />
                <p className="text-[17px] md:text-lg text-gray-700 leading-8">
